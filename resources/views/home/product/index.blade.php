            ...
            <div class="div clr-float">
                ...
                <div class="fl-right">
                    ...
                    <ul>
                        ...
                        <li class="fl-right">
                            <button class="no cmd-modal-widget green rds4 " data-toggle="modal" data-target="#modal-product" data-type="add" role="off">
                        ...
                        <li class="fl-left">
                            ...
                            <form metode="GET" action="/api/product/table" id="form-table" aria-categori="false" data-filter="false">
                                <div class="ar-li">
                                
                                    <div class="ar-src" aria-role="false">
                                        <input type="text" placeholder="Cari Nama Produk" name="search" class="" value="">
        ...
        <div class="tr" data-id="{id}" data-token="{token}">
            <div class="thr">
                <div class="div clr-float">
                    ...
                    <div class="spc">
                        <span class="txt11">CODE. #{code}</span>
                    </div>
...
$(document).ready(function(){
    ...
    function temp_table(e,w,y){
        ...
        $.each(data, function(i,item){
            ...
            listx = listx.replace("{price}", formatRupiah(item.price,"Rp") );
            listx = listx.replace("{quantity}", formatRupiah(item.quantity) );
            listx = listx.replace("{description}", item.description);
            listx = listx.replace("{date}", item.date);
            listx = listx.replace("{images}", "<img src='"+item.images+"' alt='"+item.name+"'>");
